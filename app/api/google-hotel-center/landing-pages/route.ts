...
import { buildHotelCenterLandingPagesXml, getHotelCenterData } from "@/lib/hotel-center";
...
export async function GET(request: NextRequest) {
  ...
  return new NextResponse(buildHotelCenterLandingPagesXml(content, hotelCenter), {
    headers: {
