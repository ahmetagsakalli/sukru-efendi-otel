...
import { buildHotelCenterPropertyDataXml, getHotelCenterData } from "@/lib/hotel-center";
...
export async function GET(request: NextRequest) {
  ...
  return new NextResponse(buildHotelCenterPropertyDataXml(content, hotelCenter), {
    headers: {
